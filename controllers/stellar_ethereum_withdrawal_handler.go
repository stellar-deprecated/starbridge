...
type StellarEthereumWithdrawalHandler struct {
	Store                       *store.DB
	EthereumWithdrawalValidator backend.EthereumWithdrawalValidator
}

func (c *StellarEthereumWithdrawalHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
